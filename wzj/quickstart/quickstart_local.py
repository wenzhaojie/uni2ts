...
if MODEL == "moirai":
    ...
    model = MoiraiForecast(
        module=MoiraiModule.from_pretrained(f"/Users/wzj/Models/moirai-1.1-R-small"),
    ...
    model = MoiraiMoEForecast(
        module=MoiraiMoEModule.from_pretrained("/Users/wzj/Models/moirai-moe-1.0-R-small"),
        prediction_length=PDT,
        context_length=CTX,
        patch_size=16,
        num_samples=100,
